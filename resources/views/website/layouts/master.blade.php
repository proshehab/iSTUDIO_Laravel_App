    ...
    <div class="container-fluid pb-5 hero-header bg-light mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center mb-5">
                ...
                <div class="col-lg-6">
                    <h1 class="display-1 mb-4 animated slideInRight">{{ $hero->title }} <span
                            class="text-primary">{{ $hero->highlighted_word }}</span>
                        Better</h1>
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="{{ asset('website') }}/img/hero-slider-1.jpg" alt="">
                        <img class="img-fluid" src="{{ asset('website') }}/img/hero-slider-2.jpg" alt="">
                        <img class="img-fluid" src="{{ asset('website') }}/img/hero-slider-3.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-6 wow fadeIn" data-wow-delay="0.1s">
                            <img class="img-fluid" src="{{ asset('website') }}/img/about-1.jpg" alt="">
                        </div>
                        <div class="col-6 wow fadeIn" data-wow-delay="0.3s">
                            <img class="img-fluid h-75" src="{{ asset('website') }}/img/about-2.jpg" alt="">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.2s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-1.jpg"
                                    alt="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-2.jpg"
                                    alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.4s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-3.jpg"
                                    alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-4.jpg"
                                    alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.6s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-5.jpg"
                                    alt="">
                                <a class="project-overlay text-decoration-none" href="">
                        ...
                        <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.7s">
                            <div class="project-item position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('website') }}/img/project-6.jpg"
                                    alt="">
                                <a class="project-overlay text-decoration-none" href="">
                    ...
                    <div class="row g-0">
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.2s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset('website') }}/img/service-1.jpg"
                                        alt="">
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.4s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset('website') }}/img/service-2.jpg"
                                        alt="">
                                    <h3>Implement</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.6s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-light">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset('website') }}/img/service-3.jpg"
                                        alt="">
                                    <h3>Renovation</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.8s">
                            <div class="service-item h-100 d-flex flex-column justify-content-center bg-primary">
                                <a href="" class="service-img position-relative mb-4">
                                    <img class="img-fluid w-100" src="{{ asset('website') }}/img/service-4.jpg"
                                        alt="">
                                    <h3>Commercial</h3>
                                </a>
                                <p class="mb-0">Erat ipsum justo amet duo et elitr dolor, est duo duo eos lorem sed
                    ...
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.2s">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset('website') }}/img/testimonial-1.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset('website') }}/img/testimonial-2.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="testimonial-item">
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid" src="{{ asset('website') }}/img/testimonial-3.jpg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
