                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item py-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="dropdown ms-2">
                                                        <a class="text-muted dropdown-toggle font-size-14" href="#"
                                ...
                                <ul class="verti-timeline list-unstyled">
                                    <li class="event-list active">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <div>
                                                    Posted <span class="font-weight-semibold">Beautiful Day
                                                        with Friends</span> blog... <a href="#">View</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-13 text-truncate mb-1"><a href="#"
                                                        class="text-dark">Project discussion
                                                        with team</a></h5>
